...
<script LANGUAGE="VBSCRIPT">
		...
		Sub cmdStandAlone_onclick
			...
			If isobject(WMP) Then
				...
				location.href = "mms://192.168.10.40/Remote Desktop"
...
<div id="header">
	...
	<?php include("nav.php"); ?>
		...
		<div class="right_content">
			...
			<iframe width="640" height="360" src="http://www.youtube.com/embed/dBYBp9HxMss" frameborder="0" allowfullscreen></iframe>
            <BR />
            <script language="Javascript">
			...
			<PARAM NAME="URL" VALUE="mms://192.168.10.40/Remote Desktop">
